# Repository-Local Add-ons Master Plan — ironwild

## Status

**PLANNING ONLY / IMPLEMENT IN A LATER SESSION**

Target repository: `quantdale/ironwild`  
Planning branch: `plan/repo-local-addons-2026-08-28`

## Repository assessment

Browser Three.js/Vite action game with deterministic Vitest logic, Playwright E2E and an existing full verify gate.

**Decision:** `RECOMMEND_WEB_RUNTIME_DIAGNOSTICS`

Keep npm run verify as the product gate.
...
**Why it fits:** Useful for frame-time, memory, rendering, input/pointer-lock and runtime error diagnostics in the real browser game.

**Constraints:** Local build/dev targets only; diagnostic, not test authority.

### 2. Context7 MCP — RECOMMEND

**Type:** MCP

**Why it fits:** Current Three.js/Vite/browser API documentation.

**Constraints:** Docs only.

## Explicitly not recommended

- Duplicate Playwright MCP
- Global browser configuration
- Large new agent framework
